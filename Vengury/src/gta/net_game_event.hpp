...
#pragma pack(pop)
	...
	public:
		...
		{
			return Vengury::g_pointers->m_write_bitbuf_bool(this, boolean, 1);
		}
		bool ReadBool(bool* boolean)
		{
			return Vengury::g_pointers->m_read_bitbuf_bool(this, boolean, 1);
		}
		...
		{
			return Vengury::g_pointers->m_read_bitbuf_string(this, string, bits);
		}
		bool WriteByte(uint8_t integer, int bits)
		{
			return Vengury::g_pointers->m_write_bitbuf_dword(this, integer, bits);
		}
		bool ReadByte(uint8_t* integer, int bits)
		{
			uint32_t read;
			if (Vengury::g_pointers->m_read_bitbuf_dword(this, &read, bits))
			{
				*integer = read;
				return true;
			}
		...
		{
			return Vengury::g_pointers->m_read_bitbuf_dword(this, integer, bits);
		}
		bool WriteInt32(int32_t integer, int bits)
		{
			return Vengury::g_pointers->m_write_bitbuf_int32(this, integer, bits);
		}
		...
		{
			return Vengury::g_pointers->m_write_bitbuf_qword(this, integer, bits);
		}
		...
		{
			return Vengury::g_pointers->m_write_bitbuf_int64(this, integer, bits);
		}
		bool WriteRockstarId(int64_t rockstar_id)
		{
			return Vengury::g_pointers->m_write_bitbuf_int64(this, rockstar_id, sizeof(rockstar_id) * 8);
		}
		...
		{
			return Vengury::g_pointers->m_write_bitbuf_array(this, array, size, 0);
		}
		...
		{
			return Vengury::g_pointers->m_read_bitbuf_array(this, array, size, 0);
		}
